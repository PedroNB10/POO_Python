...
class LimitePrincipal(): # view Principal
    def __init__(self, root, controle):
        ...
        # serve para ser clicavel e mostrar os outros menus
...
class ControlePrincipal():       
    ...
    def insereEstudantes(self):
        self.ctrlEstudante.insereEstudantes() # essa funcao é do arquivo estudantes, ou seja chama a view de estudante 
